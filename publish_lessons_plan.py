...
parte1 = build_table(df.iloc[0:1][['Data', 'Conteúdo','Programação/Atividade']], 
    color='blue_dark')
parte1 = redefine_strong(parte1)
with open('docs/_snippets/plano_aula_1.md', 'w') as f:
    f.write(parte1)

parte2 = build_table(df.iloc[1:7][['Data', 'Conteúdo','Programação/Atividade']], 
    color='yellow_dark')
parte2 = redefine_strong(parte2)
with open('docs/_snippets/plano_aula_2.md', 'w') as f:
    f.write(parte2)

parte3 = build_table(df.iloc[7:18][['Data', 'Conteúdo','Programação/Atividade']], 
    color='green_dark')
...
parte4 = build_table(df.iloc[18:23][['Data', 'Conteúdo','Programação/Atividade']], 
    color='red_dark')
...
parte5 = build_table(df.iloc[23:][['Data', 'Conteúdo','Programação/Atividade']], 
    color='yellow_dark')
